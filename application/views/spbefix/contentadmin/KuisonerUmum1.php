											...
											if ($sub->jenisinput == "File") {
												?>
															<div class="form-group">
																...
																<embed src="<?php echo site_url('tmp/' .$jawaban->getById($id, $sub->id_pertanyaan_umum)->jawab); ?>"
																></embed>
															</div>
															<?php 
											} else {
										...
										?>
											...
											if ($data->jenisinput == "File") {
												?>
															<div class="form-group">
																<!-- <input type="file" name="jawab" class="form-control" /> -->
																<embed src="<?php echo site_url('tmp/' .$jawaban->getById($id, $data->id_pertanyaan_umum)->jawab); ?>"
																></embed>
															</div>
															<?php 
										} else {
