				...
				<div class="row">
					<div class="x_content">
						...
						<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
							...
							<div id="editdata<?php echo $key+1?>" class="modal fade" role="dialog">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal">&times;</button>
									...
									<div class="modal-body">
										...
										action="<?php echo base_url('sistem/admin/datanomenklatur/edit/'.$value->id_aplikasi_fungsional)?>"
											enctype="multipart/form-data" novalidate>
											<div>
												<input type="hidden" name="id_aplikasi_fungsional" value="<?php echo $value->id_aplikasi_fungsional ?>" >
											</div>
											<div class="item form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nama
													Instansi Pusat <span class="required">*</span></label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input id="name" class="form-control col-md-7 col-xs-12"
														data-validate-length-range="6" data-validate-words="2"
														name="aplikasi_fungsional" placeholder="" required="required"
														type="text" value="<?php echo $value->aplikasi_fungsional ?>">
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12">Select
												...
												<div class="col-sm-7 col-xs-12">
													<select class="select2_single form-control" name="id_jenis"
														...
														<?php if($value->id_jenis == $key->id_jenis){ ?>
															<option value="<?php echo $key->id_jenis ?>" selected>
																<?php echo $key->jenis ?>
															</option>
													<?php	}else{ ?>
															<option value="<?php echo $key->id_jenis ?>">
									...
									<td>
									<form method="post" action="<?php echo base_url('sistem/admin/datanomenklatur/delete/'.$value->id_aplikasi_fungsional)?>"><button type="submit" class="btn btn-danger">Delete</button>
										</form>
									</td>
									</tr>
									</table>
