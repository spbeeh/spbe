...
<!-- jQuery autocomplete -->
<script src="<?php echo base_url('gentelella/vendors/devbridge-autocomplete/dist/jquery.autocomplete.min.js') ?>">
</script>
<!-- starrr -->
...
<!-- gauge.js -->
<script src="<?php echo base_url('gentelella/vendors/gauge.js/dist/gauge.min.js') ?>"></script>
