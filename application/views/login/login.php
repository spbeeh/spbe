...
<div class="page-header-image" style="background-image:url(<?php echo base_url('Asset/assets/img/login.jpg') ?>"></div>
<div class="content">
<div class="container">
...
<button type="submit" class="btn btn-primary btn-round btn-lg btn-block" name="submit" value="login">Login</button>
...
<!--  Plugin for Switches, full documentation here: http://www.jque.re/plugins/version3/bootstrap.switch/ -->
	...
	<!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
		...
		<!--  Plugin for the DatePicker, full documentation here: https://github.com/uxsolutions/bootstrap-datepicker -->
			<script src="<?php echo base_url('Asset/assets/js/plugins/bootstrap-datepicker.js') ?>" type="text/javascript"></script>
			<!--  Google Maps Plugin    -->
