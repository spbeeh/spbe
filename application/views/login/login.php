...
<head>
	<meta charset="utf-8" />
	<link rel="apple-touch-icon" sizes="76x76" href="<php echo site_url('Asset/assets/img/apple-icon.png') ?>">
	...
	<!-- CSS Files -->
	<link href="<?php echo site_url('Asset/assets/css/bootstrap.min.css') ?>" rel="stylesheet" />
	<link href="<?php echo site_url('Asset/assets/css/now-ui-kit.css?v=1.2.0') ?>" rel="stylesheet" />
	<!-- CSS Just for demo purpose, don't include it in your project -->
	<link href="<?php echo site_url('Asset/assets/demo/demo.css') ?>" rel="stylesheet" />
</head>
...
<body class="login-page sidebar-collapse">
	...
	<div class="page-header clear-filter" filter-color="orange">
		<div class="page-header-image"
			style="background-image:url(<?php echo site_url('Asset/assets/img/Tugu_Malang.jpg') ?>"></div>
		<div class="content">
			<div class="container">
				<div class="col-md-4 ml-auto mr-auto">
					<div class="card card-login card-plain">
						<form class="form" method="Post" action="<?php echo site_url('login') ?>" role="login">
							<div class="card-header text-center">
								<div class="logo-container">
									<!-- <img src="<?php echo site_url('Asset/assets/img/now-logo.png') ?>" alt=""> -->
								</div>
							</div>
							<div class="card-body">
