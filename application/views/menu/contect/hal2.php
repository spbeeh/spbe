								...
								<div class="form-group">
									...
									<div class="col-md-2 col-sm-3 col-xs-12">
										<div class="btn-group" data-toggle="buttons">
											...
											<label class="tidak2 btn btn-primary tidak2" data-toggle-class="btn-primary"
												data-toggle-passive-class="btn-default">
												<input type="radio" name="gender" value="female"> Tidak Ada
											</label>
										</div>
						...
						<div id="step-2">
							<form class="form-horizontal form-label-left">
								<div class="form-group">
									...
									<div class="col-md-3 col-sm-2 col-xs-12">
										<input id="a23" type="text" name="apps" class="form-control a23"
											placeholder="Nama Aplikasi">
									</div>
									<div class="col-md-3 col-sm-2 col-xs-12">
										<input id="a23" type="text" name="apps" class="form-control a23"
								...
								<div class="form-group">
									...
									<div class="col-md-3 col-sm-2 col-xs-12">
										<input id="a24" type="text" name="apps" class="form-control a24"
											placeholder="Nama Aplikasi">
									</div>
									<div class="col-md-3 col-sm-2 col-xs-12">
										<input id="a24" type="text" name="apps" class="form-control a24"
						...
						<div id="step-3">
							<form class="form-horizontal form-label-left">
								<div class="form-group">
									...
									<div class="col-md-3 col-sm-2 col-xs-12">
										<input id="a31" type="text" name="apps" class="form-control a31"
											placeholder="Nama Aplikasi">
									</div>
									<div class="col-md-3 col-sm-2 col-xs-12">
										<input id=a31 type="text" name="apps" class="form-control a31"
								...
								<div class="form-group">
									...
									<div class="col-md-3 col-sm-2 col-xs-12">
										<input id="a32" type="text" name="apps" class="form-control a32"
											placeholder="Nama Aplikasi">
									</div>
									<div class="col-md-3 col-sm-2 col-xs-12">
										<input id="a32" type="text" name="apps" class="form-control a32"
						...
						<div id="step-4">
							<form class="form-horizontal form-label-left">
								<div class="form-group">
									...
									<div class="col-md-3 col-sm-2 col-xs-12">
										<input id="a33" type="text" name="apps" class="form-control a33"
											placeholder="Nama Aplikasi">
									</div>
									<div class="col-md-3 col-sm-2 col-xs-12">
										<input id="a33" type="text" name="apps" class="form-control a33"
								...
								<div class="form-group">
									...
									<div class="col-md-3 col-sm-2 col-xs-12">
										<input id="a34" type="text" name="apps" class="form-control a34"
											placeholder="Nama Aplikasi">
									</div>
									<div class="col-md-3 col-sm-2 col-xs-12">
										<input id="a34" type="text" name="apps" class="form-control a34"
						...
						<div id="step-5">
							<form class="form-horizontal form-label-left">
								<div class="form-group">
									...
									<div class="col-md-3 col-sm-2 col-xs-12">
										<input id="a35" type="text" name="apps" class="form-control a35"
											placeholder="Nama Aplikasi">
									</div>
									<div class="col-md-3 col-sm-2 col-xs-12">
										<input id="a35" type="text" name="apps" class="form-control a35"
						...
						<div id="step-6">
							<form class="form-horizontal form-label-left">
								<div class="form-group">
									...
									<div class="col-md-3 col-sm-2 col-xs-12">
										<input id="a36" type="text" name="apps" class="form-control a36"
											placeholder="Nama Aplikasi">
									</div>
									<div class="col-md-3 col-sm-2 col-xs-12">
										<input id="a36" type="text" name="apps" class="form-control a36"
